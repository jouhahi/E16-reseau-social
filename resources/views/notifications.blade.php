            ...
            <div class="panel panel-default">
              ...
              <div class="panel-heading">
                <div class="media">
                  <div class="media-left">
                    <a href="">
                      <img alt="Photo de profil" src="images/people/50/woman-6.jpg" class="media-object">
                    </a>
                  </div>
                  <div class="media-body">
                    ...
                    <span>le 21 juin 2014</span>
                  </div>
                </div>
              </div>

              <div class="panel-body">
                <p>Veux-tu m'ajouter en tant qu'ami?</p>
                <a href="#" role="button" class="btn btn-danger pull-right text-muted"><i class="fa fa-times"></i> Refuser</a>
                <a href="#" role="button" class="btn btn-success pull-right text-muted"><i class="fa fa-check-circle"></i> Accepter</a>
              </div>
