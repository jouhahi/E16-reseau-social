    ...
    <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu" data-type="collapse">
      <div data-scrollable>
        <ul class="sidebar-menu">
          ...
          <li class=" active "><a href="profil.blade.php"><i class="icon-user-1"></i> <span>Profil</span></a></li>
                ...
                <div class="width-250 width-auto-xs">
                  <div class="panel panel-default widget-user-1 text-center">
                    <div class="avatar">
                      ...
                      <h3>Joey Dubé</h3>
                      <a href="#" class="btn btn-primary">Modifier la photo de profil <i class="fa fa-pencil fa-fw"></i></a>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="panel panel-default">
                      <div class="panel-heading panel-heading-gray">
                        <i class="fa fa-fw fa-info-circle"></i> À propos
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="panel panel-default">
                      <div class="panel-heading panel-heading-gray">
                        <div class="pull-right">
                          <a href="rechercher.blade.php" class="btn btn-primary btn-xs">Ajouter <i class="fa fa-plus"></i></a>
                        </div>
                        <i class="icon-user-1"></i> Amis
                      </div>
                      <div class="panel-body">
                        <ul class="img-grid">
                          <li>
